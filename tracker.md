...
| 🟢 | `LOW` | **Payment Card Clipping Fix** | Reduced vertical kiosk padding + `MaxHeight` guard on `CardsGrid` in `PaymentOptionView` and `PaymentSelectionView` to prevent bottom-row card clipping at 1080×1920 without scrolling. | [PaymentOptionView.xaml](file:///c:/Users/viti/source/repos/SelfCheckoutKiosk-V2%20-%20Merge/src/SelfCheckoutKiosk.App/Views/Customer/PaymentOptionView.xaml) · [PaymentSelectionView.xaml](file:///c:/Users/viti/source/repos/SelfCheckoutKiosk-V2%20-%20Merge/src/SelfCheckoutKiosk.App/Views/Customer/PaymentSelectionView.xaml) |
