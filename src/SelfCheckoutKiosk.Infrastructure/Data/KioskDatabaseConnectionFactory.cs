...
public sealed class KioskDatabaseConnectionFactory
{
     ...
     */
    private static readonly bool _isWinsqlite3;
    ...
    private static bool IsWinsqlite3Provider() => _isWinsqlite3;
        ...
        string encryptionKey)
    {
        ...
        /*
         * Microsoft.Data.Sqlite applies Password as PRAGMA key immediately
         * after connection open when the native SQLite implementation supports
         * encryption. When winsqlite3 is used, Password must not be set.
         */
        if (!IsWinsqlite3Provider())
        {
