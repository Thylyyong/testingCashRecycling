...
public sealed class LLCoreLogicEngine : ILLCoreLogicEngine
{
    ...
    /// <summary>
    /// Testable and public constructor that depends on the offline-license
    /// abstraction. Optional parameters preserve existing construction code while
    /// allowing tests to inject deterministic policy and audit dependencies.
    /// </summary>
